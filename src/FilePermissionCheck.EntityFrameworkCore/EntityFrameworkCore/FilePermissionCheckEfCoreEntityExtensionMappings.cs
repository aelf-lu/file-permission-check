...
public static class FilePermissionCheckEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE FilePermissionCheckModuleExtensionConfigurator CLASS (in the Domain.Shared project)
